...
-- FROM sql_schema.employees
-- INNER JOIN sql_schema.dept_emp ON
-- sql_schema.employees.empno = sql_schema.dept_emp.empno
-- INNER JOIN sql_schema.departments ON
-- sql_schema.dept_emp.deptno = sql_schema.departments.deptno 
...
--List the frequency count of employee last names (i.e., howgit many employees share each last name) in descending order.
